...
worker_yael = Worker("Yael Hadad", ['ATEGen', 'SVFSTIL', 'STILEDITOR','WAVER', 'GENERAL'], 30, 14, 0, [],'12345',
                     [A1,A2,B1,B2,C1],[A2,B1,B2],0,0,0,0,)
worker_elad = Worker("Elad Motzny", ['CONVMGR', 'ATEGEN', 'STILEDITOR', 'VCDSTIL'], 30, 14, 0,[], '12344',
                    [A1,C1,C2],[C2],0,0,0,0)
...
for task in all_tasks:
    ...
    if (len(workers_with_less_unique) == 1):
        assign_task(workers_with_less_unique[FIRST], task)
        ...
        assign_task(workers_with_max_availability[FIRST], task)
